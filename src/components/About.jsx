    ...
    <div className="border-b border-transparent pb-4">
        ...
        <div className="flex flex-wrap">
            ...
            <div className="flex justify-center lg:justify-start">
                <p className="my-2 max-w-xl py-6"> Hi I am Harshit Sharma. I am an aspiring AI and Data Science professional pursuing a B.Tech at Shiv Nadar University, Chennai. My passion for technology and problem-solving has led me to specialize in AI and Data Science, where I thrive in challenging environments that push me to think creatively.
